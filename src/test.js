;<div className='App'>
  ...
  <ul>
    ...
    <li>
      Create <code>genere</code> route to display only movies from this specific{' '}
      <code>genere</code>
    </li>
    <li>
    ...
    <li>
      Create <code>/watchlist/$id</code> route where you can check the list of
      the movies you&#39;ve previously added.
    </li>
